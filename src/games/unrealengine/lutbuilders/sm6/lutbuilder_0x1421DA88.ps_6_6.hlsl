// Found in The Blood of Dawnwalker (UE5 LUT builder, SDR output, with white balance)
// Same code as 0x8146D205 (Deadzone: Rogue) (decompiles identically; bytecode hash differs)
...
float4 main(
  ...
  float _255 = mad(_234, (WorkingColorSpace_000[2].x), mad(_231, (WorkingColorSpace_000[1].x), (_228 * (WorkingColorSpace_000[0].x))));
  float _258 = mad(_234, (WorkingColorSpace_000[2].y), mad(_231, (WorkingColorSpace_000[1].y), (_228 * (WorkingColorSpace_000[0].y))));
  float _261 = mad(_234, (WorkingColorSpace_000[2].z), mad(_231, (WorkingColorSpace_000[1].z), (_228 * (WorkingColorSpace_000[0].z))));
  ...
  float _309 = mad(mad((WorkingColorSpace_064[0].z), _279, mad((WorkingColorSpace_064[0].y), _270, (_261 * (WorkingColorSpace_064[0].x)))), _62, mad(mad((WorkingColorSpace_064[0].z), _276, mad((WorkingColorSpace_064[0].y), _267, (_258 * (WorkingColorSpace_064[0].x)))), _61, (mad((WorkingColorSpace_064[0].z), _273, mad((WorkingColorSpace_064[0].y), _264, (_255 * (WorkingColorSpace_064[0].x)))) * _60)));
  float _312 = mad(mad((WorkingColorSpace_064[1].z), _279, mad((WorkingColorSpace_064[1].y), _270, (_261 * (WorkingColorSpace_064[1].x)))), _62, mad(mad((WorkingColorSpace_064[1].z), _276, mad((WorkingColorSpace_064[1].y), _267, (_258 * (WorkingColorSpace_064[1].x)))), _61, (mad((WorkingColorSpace_064[1].z), _273, mad((WorkingColorSpace_064[1].y), _264, (_255 * (WorkingColorSpace_064[1].x)))) * _60)));
  float _315 = mad(mad((WorkingColorSpace_064[2].z), _279, mad((WorkingColorSpace_064[2].y), _270, (_261 * (WorkingColorSpace_064[2].x)))), _62, mad(mad((WorkingColorSpace_064[2].z), _276, mad((WorkingColorSpace_064[2].y), _267, (_258 * (WorkingColorSpace_064[2].x)))), _61, (mad((WorkingColorSpace_064[2].z), _273, mad((WorkingColorSpace_064[2].y), _264, (_255 * (WorkingColorSpace_064[2].x)))) * _60)));
  float _330 = mad((WorkingColorSpace_128[0].z), _315, mad((WorkingColorSpace_128[0].y), _312, ((WorkingColorSpace_128[0].x) * _309)));
  float _333 = mad((WorkingColorSpace_128[1].z), _315, mad((WorkingColorSpace_128[1].y), _312, ((WorkingColorSpace_128[1].x) * _309)));
  float _336 = mad((WorkingColorSpace_128[2].z), _315, mad((WorkingColorSpace_128[2].y), _312, ((WorkingColorSpace_128[2].x) * _309)));
  ...
  float _906 = (cb0_038x + 1.0f) - cb0_037z;
  float _908 = cb0_038y + 1.0f;
  float _910 = _908 - cb0_037w;
  if (cb0_037z > 0.800000011920929f) {
    _928 = (((0.8199999928474426f - cb0_037z) / cb0_037y) + -0.7447274923324585f);
  } else {
    float _919 = (cb0_038x + 0.18000000715255737f) / _906;
    _928 = (-0.7447274923324585f - ((log2(_919 / (2.0f - _919)) * 0.3465735912322998f) * (_906 / cb0_037y)));
  }
  float _931 = ((1.0f - cb0_037z) / cb0_037y) - _928;
  float _933 = (cb0_037w / cb0_037y) - _931;
  ...
  float _943 = cb0_037y * (_937 + _931);
  float _944 = cb0_037y * (_938 + _931);
  float _945 = cb0_037y * (_939 + _931);
  float _946 = _906 * 2.0f;
  float _948 = (cb0_037y * -2.0f) / _906;
  float _949 = _937 - _928;
  float _950 = _938 - _928;
  float _951 = _939 - _928;
  float _970 = _910 * 2.0f;
  float _972 = (cb0_037y * 2.0f) / _910;
  float _997 = select((_937 < _928), ((_946 / (exp2((_949 * 1.4426950216293335f) * _948) + 1.0f)) - cb0_038x), _943);
  float _998 = select((_938 < _928), ((_946 / (exp2((_950 * 1.4426950216293335f) * _948) + 1.0f)) - cb0_038x), _944);
  float _999 = select((_939 < _928), ((_946 / (exp2((_951 * 1.4426950216293335f) * _948) + 1.0f)) - cb0_038x), _945);
  ...
  float _1061 = (cb0_037x * (max(0.0f, (lerp(_1041, _1038, 0.9300000071525574f))) - _757)) + _757;
  float _1062 = (cb0_037x * (max(0.0f, (lerp(_1041, _1039, 0.9300000071525574f))) - _758)) + _758;
  float _1063 = (cb0_037x * (max(0.0f, (lerp(_1041, _1040, 0.9300000071525574f))) - _759)) + _759;
  float _1079 = ((mad(-0.06537103652954102f, _1063, mad(1.451815478503704e-06f, _1062, (_1061 * 1.065374732017517f))) - _1061) * cb0_036z) + _1061;
  float _1080 = ((mad(-0.20366770029067993f, _1063, mad(1.2036634683609009f, _1062, (_1061 * -2.57161445915699e-07f))) - _1062) * cb0_036z) + _1062;
  float _1081 = ((mad(0.9999996423721313f, _1063, mad(2.0954757928848267e-08f, _1062, (_1061 * 1.862645149230957e-08f))) - _1063) * cb0_036z) + _1063;

  SetTonemappedAP1(_1079, _1080, _1081);

  float _1103 = max(0.0f, mad((WorkingColorSpace_192[0].z), _1081, mad((WorkingColorSpace_192[0].y), _1080, ((WorkingColorSpace_192[0].x) * _1079))));
  float _1104 = max(0.0f, mad((WorkingColorSpace_192[1].z), _1081, mad((WorkingColorSpace_192[1].y), _1080, ((WorkingColorSpace_192[1].x) * _1079))));
  float _1105 = max(0.0f, mad((WorkingColorSpace_192[2].z), _1081, mad((WorkingColorSpace_192[2].y), _1080, ((WorkingColorSpace_192[2].x) * _1079))));
  float _1131 = cb0_014x * (((cb0_039y + (cb0_039x * _1103)) * _1103) + cb0_039z);
  float _1132 = cb0_014y * (((cb0_039y + (cb0_039x * _1104)) * _1104) + cb0_039z);
  float _1133 = cb0_014z * (((cb0_039y + (cb0_039x * _1105)) * _1105) + cb0_039z);
  float _1154 = exp2(log2(max(0.0f, (lerp(_1131, cb0_013x, cb0_013w)))) * cb0_040y);
  float _1155 = exp2(log2(max(0.0f, (lerp(_1132, cb0_013y, cb0_013w)))) * cb0_040y);
  float _1156 = exp2(log2(max(0.0f, (lerp(_1133, cb0_013z, cb0_013w)))) * cb0_040y);

  if (RENODX_TONE_MAP_TYPE != 0) {
    return GenerateOutput(float3(_1154, _1155, _1156));
  }

  if (WorkingColorSpace_320 == 0) {
    float _1163 = mad((WorkingColorSpace_128[0].z), _1156, mad((WorkingColorSpace_128[0].y), _1155, ((WorkingColorSpace_128[0].x) * _1154)));
    float _1166 = mad((WorkingColorSpace_128[1].z), _1156, mad((WorkingColorSpace_128[1].y), _1155, ((WorkingColorSpace_128[1].x) * _1154)));
    float _1169 = mad((WorkingColorSpace_128[2].z), _1156, mad((WorkingColorSpace_128[2].y), _1155, ((WorkingColorSpace_128[2].x) * _1154)));
