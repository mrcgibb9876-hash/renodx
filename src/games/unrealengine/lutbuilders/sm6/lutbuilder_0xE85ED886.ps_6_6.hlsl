// Found in The Blood of Dawnwalker (UE5 LUT builder, SDR output, no white balance)
// Same code as 0xAD0A58C0 (Deadzone: Rogue) (decompiles identically; bytecode hash differs)
