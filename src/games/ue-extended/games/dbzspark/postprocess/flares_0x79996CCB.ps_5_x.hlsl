...
void main(
  ...
  r2.xyz = DBZSPARK_PqToSrgbLutSpace(r2.xyz);
  r1.xyz = t7.Sample(s5_s, r1.xy).xyz;
  r1.xyz = DBZSPARK_PqToSrgbLutSpace(r1.xyz, bridge_state);
  ...
  o0.xyz = DBZSPARK_SrgbLutSpaceToPq(max(float3(0, 0, 0), r0.xyz), bridge_state);
  o0.w = 0;
}