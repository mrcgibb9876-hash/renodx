...
void main(
  ...
  r0.x = r0.y * r0.x;
  r5.x = dot(float3(1.37041271, -0.329291314, -0.0636827648), r1.xyz);
  r5.y = dot(float3(-0.0834341869, 1.09709096, -0.0108615728), r1.xyz);
  r5.z = dot(float3(-0.0257932581, -0.0986256376, 1.20369434), r1.xyz);
  ...
  cb_config.ue_filmblackclip = asfloat(cb0[37].w);
  cb_config.ue_filmtoe = asfloat(cb0[37].y);
  cb_config.ue_filmshoulder = asfloat(cb0[37].z);
  ...
  r5.xyz = t1.Sample(s1_s, r5.yw).xyz;  // Sampling two luts
